...
<b>Задача 3.5</b><br>
<b>Анкета "Ваш характер"</b><br>
<HTML>
<BODY>
<FORM method="post" action="<?php print $PHP_SELF ?>">
Введите ваше имя: <INPUT type="text" name="a" size="30">
...
<P> <INPUT type="submit" name="obr" value="Анализировать результаты">
</FORM>
<?
if (isset($_POST["obr"])) {
...
echo ('<br> Ваш результат: '.$sum. ' баллов.');
}
?>
</BODY> </HTML>
